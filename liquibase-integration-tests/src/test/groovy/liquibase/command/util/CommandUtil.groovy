...
class CommandUtil {
    ...
    static void runGenerateChangelog(DatabaseTestSystem db, String outputFile, String diffTypes) throws CommandExecutionException {
        ...
        if (null != diffTypes) {
            commandScope.addArgumentValue(PreCompareCommandStep.DIFF_TYPES_ARG, diffTypes)
        }

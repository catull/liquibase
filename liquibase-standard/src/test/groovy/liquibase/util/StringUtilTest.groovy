...
class StringUtilTest extends Specification {
    ...
    def "processMultilineSql examples"() {
        ...
        true          | true            | null         | "SELECT 'a\\'b;\nc';"                                                                                                                                                                                | ["SELECT 'a\\'b;\nc'"]
        true          | true            | null         | "SELECT 'a\\'b;\nc'; SELECT 2;"                                                                                                                                                                      | ["SELECT 'a\\'b;\nc'", "SELECT 2"]
        true          | true            | null         | "INSERT INTO t VALUES ('a\\'b;\nc'); SELECT * FROM t;"                                                                                                                                               | ["INSERT INTO t VALUES ('a\\'b;\nc')", "SELECT * FROM t"]
        true          | true            | null         | "SELECT \"a\\\"b;\nc\";"                                                                                                                                                                             | ["SELECT \"a\\\"b;\nc\""]
        true          | true            | null         | "INSERT INTO t VALUES ('<div class=\\'test\\'>;\ndata</div>'); SELECT 2;"                                                                                                                            | ["INSERT INTO t VALUES ('<div class=\\'test\\'>;\ndata</div>')", "SELECT 2"]
